...
namespace TestProject1
{
    public class Tests
    {
        ...
        [TestCase(22, 2, 10, 1, 255, 1, 1)]
        [TestCase(23, 3, 5, 2, 3, 1, 1)]
        [TestCase(24, 15, 200, 255, 255, 1, 33)]
        [TestCase(25, 16, 200, 255, 254, 1, 34)]
        [TestCase(26, 17, 200, 255, 128, 1, 36)]
        [TestCase(27, 33, 77, 77, 77, 1, 25)]
        [TestCase(28, 48, 33, 99, 11, 4, 508)]
        [TestCase(29, 55, 44, 88, 22, 1, 44)]
        [TestCase(30, 66, 11, 11, 11, 1, 8)]
        [TestCase(31, 77, 123, 200, 100, 2, 326)]
        [TestCase(32, 88, 200, 100, 50, 4, 1197)]
        [TestCase(33, 10, 200, 200, 200, 0, 0)]
        [TestCase(34, 50, 255, 100, 50, 0, 0)]
        [TestCase(35, 75, 180, 255, 180, 0, 0)]
        [TestCase(36, 99, 255, 255, 1, 0, 0)]
        [TestCase(37, 25, 60, 40, 20, 0, 0)]
        [TestCase(38, 60, 100, 255, 128, 1, 40)]
        [TestCase(39, 80, 90, 45, 90, 1, 17)]
        [TestCase(40, 99, 200, 150, 150, 1, 84)]
